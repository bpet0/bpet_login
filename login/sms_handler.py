...
access_key_id = 'LTAIS6AQVEuEIYLH'
access_key_secret = 'kfDJSQx3MjefKDKRHuUl9iqXr58jyZ'
server_address = 'https://dysmsapi.aliyuncs.com'
#定义参数
user_params = {
    'Action':'SendSms',
    'TemplateParam': '{"code":"1221"}',
    'PhoneNumbers': '15123245787,18513100323',
    'SignName': '百宠',
    'TemplateCode': 'SMS_120770179'
}
...
def send_sms(code, phoneNumbers):
    sms = {
        'Action': 'SendSms',
        'TemplateParam': '{"code":' + str(code) + '}',
        'PhoneNumbers': phoneNumbers,
        'SignName': '百宠',
        'TemplateCode': 'SMS_122296328'
    }
