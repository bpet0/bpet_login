...
class User(Base):
    ...
    user_name = Column('user_name', String(128), unique=True)
    nick_name = Column('nick_name', String(128))
    phone_num = Column('phone_num', String(32), unique=True)
    ...
    default_pet = Column('default_pet', Integer)
    head_portrait = Column('head_portrait', String(256))
